...
export const Tips = (props) => {
  return (
    <div id="tips">
      <div className="container tips-text">
            ...
            <div className="col-lg-6 col-sm-6 col-xs-12">
              <ul>
                ...
                <ol style={{ paddingLeft: '20px' }}>
                  <li className="dot">Portrait (in a size of a passport photo, but with a smile)</li>
                  <li className="dot">Photo from your right side</li>
                  <li className="dot">Photo from your left side</li>
                  <li className="dot">Full body shot</li>
                </ol>
              </ul>
            </div>
